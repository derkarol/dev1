...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal">Transactional</button>
...
<div data-modal id="modal--danger" class="bx--modal bx--modal--danger" tabindex="-1">
  <div class="bx--modal-container">
    ...
    <div class="bx--modal-footer">
      ...
      <button class="bx--btn bx--btn--danger--primary" type="button" aria-label="danger" data-modal-primary-focus>Danger button</button>
    </div>
  </div>
</div>