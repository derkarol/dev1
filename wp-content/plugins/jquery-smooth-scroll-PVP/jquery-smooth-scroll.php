<?php
/*
Plugin Name: jQuery Smooth Scroll PVP
Version: 1.4.4
...
if ( !class_exists( 'jQuerySmoothScroll' ) ) {
	...
	class jQuerySmoothScroll {
		...
		public function __construct() {
			...
			$pluginname = 'jQuery Smooth Scroll-PVP';
		...
		public function wp_footer() {
			...
			<a class="arrow scroll-up" id="scroll-to-top" href="#" title="<?php _e('Scroll to Top','blogsynthesis'); ?>"><?php _e('Top','blogsynthesis'); ?></a>
			<?php
		}
